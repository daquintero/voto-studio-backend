...
from data.regex import remove_field_from_rels_dict
...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser.add_argument('--field_name', action='store', dest='field_name', help='The name of the field to remove')
